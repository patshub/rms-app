...
// ****************************************
  ...
  // ******************
    ...
    jQuery('.print-options .cancel').click(function(){
      ...
      // Single Pages
      jQuery('#tab1').css('display','block');  //Show both tabs for printing
      jQuery('#tab2').css('display','none');  //Show both tabs for printing
      jQuery('#tab3').css('display','none');  //Show both tabs for printing
      jQuery('#tab4').css('display','none');  //Show both tabs for printing
      // jQuery('#'+jQuery('.path-node .tab-menu .item').not('.active').attr('tab-id')).toggle();  //Hide the Inactive Tab (keep displaying last active)
