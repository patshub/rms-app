...
jQuery( document ).ready(function() {
  ...
  // Set all info box height equal to each other
  jQuery(window).on('load resize', function(){
    var win = jQuery(this);
    if (win.width() > 500) {
         jQuery('.info-block-3.home.block-1 .block-desc').css('min-height', 0);
         var maxHeight = Math.max.apply(null, jQuery(".info-block-3.home.block-1 .block-desc").map(function ()
         {
              return jQuery(this).height();
         }).get());
         jQuery('.info-block-3.home.block-1 .block-desc').css('min-height', maxHeight+20);
    } else {
         jQuery('.info-block-3.home.block-1 .block-desc').css('min-height', 0);
    }
   });
  ...
  jQuery('.path-insurance #print-labels-btn').remove();
  jQuery('.path-insurance .label-printing').remove();
  ...
  jQuery('.path-record-labels ul.breadcrumbs').append('<li class="label-printing">Print Labels</li>');
...
// ***************
  ...
  jQuery(document).delegate('.btn.reset.form-submit','click',function(event) {
    ...
    jQuery('form.views-exposed-form').each(function() {
      jQuery(this).find('select option').removeAttr('selected');  // Reset Select Fields
      ...
      // jQuery('.js-form-type-radio:first-child input[type=radio]').attr('value',"Active");
...
// ****************************************
  ...
  function printReady_report(){
    ...
    // Single Pages
    jQuery('#tab1').css('display','block');  //Show both tabs for printing
    jQuery('#tab2').css('display','block');  //Show both tabs for printing
    jQuery('#tab3').css('display','block');  //Show both tabs for printing
    jQuery('#tab4').css('display','block');  //Show both tabs for printing
...
// ****************************************
  ...
  // ******************
    ...
    jQuery('.print-options .cancel').click(function(){
      ...
      jQuery('#'+jQuery('.tab-menu .item').not('.active').attr('tab-id')).toggle();  //Hide the Inactive Tab (keep displaying last active)
  ...
  // ***********
    ...
    jQuery('.tab-menu .item').click(function(){
      ...
      // jQuery('#'+jQuery(this).attr('tab-id')).css('display','block');
      // jQuery('#'+jQuery('.tab-menu .item').not(this).attr('tab-id')).css('display','none');

      jQuery('.tab-body > div').removeClass('active');
    ...
    if(insurance_type_value != 'All'){
      ...
      jQuery('.filter-container .tab-body > div').removeClass('active');
