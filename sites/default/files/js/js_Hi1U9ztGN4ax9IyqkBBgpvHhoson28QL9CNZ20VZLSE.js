...
// ****************************************
  ...
  // ORGANIZE FIELDS
    ...
    // var health_com_total = 0;
    // // Generate Commissions TOTAL
    // jQuery('.health-commissions .info-set-item p strong').each(function(){
    //   var float_value = $(this).text().replace("$", "");
    //   var num_value = parseFloat(float_value);
    //   health_com_total += num_value;
    // });
    // jQuery('.health-commissions .commissions-total p strong').text(health_com_total);
    //
    ...
    function generate_total_commissions(type){
      ...
      jQuery(type+' .info-set-item p strong').text(total);
    }

    generate_total_commissions('.health_commissions');
});
